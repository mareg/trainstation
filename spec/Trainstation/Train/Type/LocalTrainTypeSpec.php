...
class LocalTrainTypeSpec extends ObjectBehavior
{
    ...
    function it_can_use_a_track_with_a_short_platform()
    {
        $track = new Track(2, Platform::short());
    ...
    {
        $track = new Track(2, Platform::long());

        $this->canUseTrack($track)->shouldBe(true);
    }

    function it_cannot_use_a_track_without_platform()
    {
        $track = new Track(2);
